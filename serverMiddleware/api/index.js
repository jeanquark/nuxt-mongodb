...
connect();
function connect() {
   	return mongoose.connect('mongodb://127.0.0.1:27017/node_express_mongoose_demo', { keepAlive: 1, useCreateIndex: true, useNewUrlParser: true, useUnifiedTopology: true });
}
